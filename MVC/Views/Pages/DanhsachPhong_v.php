...
<body>
        ...
        <!-- Thêm mới -->
        <form method="post" action="http://localhost:8088/QuanLyKyTucXa_new/themPhong_c/themmoi">
    <div class="modal-add">
...
<form method="post" action="http://localhost:8088/QuanLyKyTucXa_new/DanhsachPhong_c/suadl">
        ...
        <!-- Tìm kiếm -->
        <form method="post" action="http://localhost:8088/QuanLyKyTucXa_new/DanhsachPhong_c/timkiem" enctype="multipart/form-data">
            <div class="main">
        <div class="header">
            ...
            <div>
                <table style=" text-align:center">
                    ...
                    <tr >
                        ...
                        <div><a href="http://localhost:8088/QuanLyKyTucXa_new//DanhsachPhong_c/" style="margin: 10px 0px; background-color: #0d6efd;" class="btn btn-success" name="btnReLoad"><i class="fa-solid fa-rotate-right"></i> Reload</a></div>
                    </tr>
                    <tr>
                        <td></td>
                ...
                if (isset($data['dulieu']) && mysqli_num_rows($data['dulieu']) > 0) {
                    ...
                    <tr >
                        ...
                        <td><?php echo $row['soNguoi'] ?></td>
                         ...
                         <a onclick="return confirm('Bạn có muốn xóa phòng này không?');" href="http://localhost:8088/QuanLyKyTucXa_new/DanhsachPhong_c/xoa/<?php echo $row['maPhong'] ?>" class="btn btn-outline-danger"><i style="color: red;" class="fa-solid fa-trash"></i></a>
                         <a href="http://localhost:8088/QuanLyKyTucXa_new/DanhsachPhong_c/lien_ket/<?php echo $row['maHopDong'] ?>" class="btn btn-outline-danger"><i style="color: red;" ></i>Chi tiết</a> 
                        </td>
                     </tr>
                         <?php
                    }
