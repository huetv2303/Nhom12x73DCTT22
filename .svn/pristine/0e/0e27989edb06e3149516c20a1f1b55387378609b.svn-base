...
<body>
        ...
        <!-- Thêm mới -->
        <form method="post" action="http://localhost/Nhom12x73DCTT22/themToa_c/themmoi">
...
<form method="post" action="http://localhost/Nhom12x73DCTT22/Toa_c/suadl">
    ...
    <form>  
        ...
        <div class="header">
            ...
            <a href="http://localhost/Nhom12x73DCTT22/Toa_c/" style="margin: 10px 0px; background-color: #0d6efd;" class="btn btn-success" name="btnReLoad"><i class="fa-solid fa-rotate-right"></i> Reload</a>
            ...
            <table class="table table-striped" style="text-align:center " >        
                    ...
                    if (isset($data['dulieu']) && mysqli_num_rows($data['dulieu']) > 0) {
                        ...
                        <tr >
                            ...
                            <a onclick="return confirm('Bạn có muốn xóa tòa này không?');" href="http://localhost/Nhom12x73DCTT22/Toa_c/xoa/<?php echo $row['maToa'] ?>" class="btn btn-outline-danger"><i style="color: red;" class="fa-solid fa-trash"></i></a>
                            <a href="http://localhost/Nhom12x73DCTT22/Toa_c/lien_ket/<?php echo $row['maToa'] ?>" class="btn btn-outline-danger"><i style="color: red;" ></i>Chi tiết</a> 
                            </td>
                        </tr>
                            <?php
                        }
