...
<body>
    <div id="wrapper" style="height: -webkit-fill-available;">
        <form method="post" action="http://localhost/Nhom12x73DCTT22/DanhsachSV/timKiem">
                ...
                <table class="table table-striped" style="text-align: center;">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="http://localhost/Nhom12x73DCTT22/DanhsachSV/sua/<?php echo $row['maSinhVien'] ?>" class="btn btn-outline-primary">Sửa</a> &nbsp;
                                    <a onclick="return confirm('Bạn có muốn xóa sinh viên này không?');" href="http://localhost/Nhom12x73DCTT22/DanhsachSV/xoa/<?php echo $row['maSinhVien'] ?>" class="btn btn-outline-danger">Xóa</a>
                                </td>
                            </tr>
                    <?php
                        }
    ...
    <form action="http://localhost/Nhom12x73DCTT22/DanhsachSv/ImportExcel" method="post" enctype="multipart/form-data">
