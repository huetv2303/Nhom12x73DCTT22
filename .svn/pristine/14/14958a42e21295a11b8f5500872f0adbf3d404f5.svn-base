...
<body>
    <div class="main">
        <form method="post" action="http://localhost:8088/Nhom12x73DCTT22/DsNhanVien/Search">
            <div>
                <div class="header">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        ...
                                        <a href="http://localhost:8088/Nhom12x73DCTT22/DsNhanVien/loadForm/<?php echo $row['MaNhanVien'] ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square">&nbsp;&nbsp;</i>Sửa</a> &nbsp;
                                        <a href="http://localhost:8088/Nhom12x73DCTT22/DsNhanVien/Delete/<?php echo $row['MaNhanVien'] ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash">&nbsp;&nbsp;</i>Xóa</a>
                                    </td>
                                </tr>
                        <?php
                            }
    ...
    <form action="http://localhost:8088/Nhom12x73DCTT22/DsNhanVien/ImportExcel" method="post" enctype="multipart/form-data">
